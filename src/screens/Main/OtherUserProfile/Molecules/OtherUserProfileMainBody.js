...
import OtherUserProfileTopNav from './OtherUserProfileTopNav';

const OtherUserProfileMainBody = ({userData, authUser}) => {
  ...
  return (
    <View style={{width: '100%'}}>
      ...
      {userData?.privateProfile ? (
        ...
        <View style={{width: '100%', height: verticalScale(400)}}>
          <OtherUserProfileTopNav userData={userData} />
        </View>
      )}
      {/* </View> */}
      {/* <SepratorLine height={8} />
...
export default OtherUserProfileMainBody;
