...
const UserStats = ({route}) => {
  const statsArray = [
    ...
    {id: 7, name: 'Skill #3', value: route?.params?.skill3},
    {
      id: 8,
      name: 'Age',
      value: route?.params?.age ? route?.params?.age + ' ' + 'years' : '',
    },
    {
      id: 9,
      name: 'Email',
      value: route?.params?.email ? route?.params?.email : '____________',
    },
    {id: 10, name: 'Height', value: route?.params?.height},
    {id: 11, name: 'Strong Hand', value: route?.params?.strongHand},
    {id: 12, name: 'Strong Foot', value: route?.params?.strongFoot},
  ];
